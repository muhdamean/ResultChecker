...
namespace ResultChecker.Migrations
{
    ...
    [Migration("20210823065711_vwResultUpload")]
    partial class vwResultUpload
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ResultChecker.Models.CourseLecturer", b =>
                {
                    ...
                    b.Property<int>("SessionSemesterId")
                        .HasColumnType("integer")
                        .HasColumnName("sessionsemesterid");
                    ...
                    b.HasIndex("SessionSemesterId")
                        .HasDatabaseName("ix_courselecturers_sessionsemesterid");
            ...
            modelBuilder.Entity("ResultChecker.Models.CourseLecturer", b =>
                {
                    b.HasOne("ResultChecker.Models.SessionSemester", "SessionSemester")
                        .WithMany()
                        .HasForeignKey("SessionSemesterId")
                        .HasConstraintName("fk_courselecturers_sessionsemesters_sessionsemesterid")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
