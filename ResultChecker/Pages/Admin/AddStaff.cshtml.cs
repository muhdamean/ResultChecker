...
namespace ResultChecker.Pages.Admin
{
    ...
    public class AddStaffModel : PageModel
    {
        ...
        public AddStaffModel(AppDbContext dbContext, UserManager<ApplicationUser> userManager, IWebHostEnvironment webHostEnvironment, ILogger<AddStaffModel> logger, IMailService mailService)
        {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            if (ModelState.IsValid)
            {
                ...
                ApplicationUser user = new ApplicationUser
                {
                    ...
                    Role = ApplicationUsers.Role,
                    DateSubmitted = DateTime.Now.Date,
                    Religion=ApplicationUsers.Religion
                };
                ...
                if (result.Succeeded)
                {
                    ...
                    TempData["message"] = $"Created successfully. Confirmation link has been sent to {ApplicationUsers.Email}, please confirm your email";
